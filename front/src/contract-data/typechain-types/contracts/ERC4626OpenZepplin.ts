...
export interface ERC4626OpenZepplinInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "allowance"
      | "approve"
...
export interface ERC4626OpenZepplin extends BaseContract {
  connect(runner?: ContractRunner | null): ERC4626OpenZepplin;
  waitForDeployment(): Promise<this>;

  interface: ERC4626OpenZepplinInterface;
